...
public class RegexUtils {
     ...
     * 
     * @param email
     *            email地址，格式：zhangsan@gtexpress.cn，zhangsan@xxx.com.cn，xxx代表邮件服务商
     * 
    ...
    public static boolean checkIdCard(String idCard) {
        String regex = "[1-9](\\d{13}||\\d{16})[a-zA-Z0-9]{1}";
     ...
     * 
     *            <国家（地区） 代码 ：</b>标识电话号码的国家（地区）的标准国家（地区）代码。它包含从 0 到 9 的一位或多位数字，
     * 
     *            数字之后是空格分隔的国家（地区）代码。
     * 
     ...
     * 
     * @param url
     *            格式：http://blog.csdn.net/weixin_38824230/article/details/73936630
